  ...
  return (
    <div className="flex flex-col h-full bg-navy-900 pb-24">
      <header className="pt-safe pt-8 px-6 pb-4 flex items-center gap-4 border-b border-navy-800">
        <button data-testid='btn-suggestproduct-1' onClick={() => navigate(-1)} className="p-2 -ml-2 rounded-full hover:bg-navy-800 transition-colors">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-6 py-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input data-testid='input-suggestproduct-1'
              type="text"
              value={productName}
          ...
          <div className="space-y-2">
            ...
            <input data-testid='input-suggestproduct-2'
              type="text"
              value={brandName}
          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button data-testid='btn-suggestproduct-2' type="button" className="flex flex-col items-center justify-center gap-2 h-32 bg-navy-800 border border-navy-700 border-dashed rounded-xl hover:bg-navy-700 transition-colors text-content-secondary hover:text-white">
                <Camera className="w-8 h-8" />
                <span className="text-sm font-medium">Front Label</span>
              </button>
              <button data-testid='btn-suggestproduct-3' type="button" className="flex flex-col items-center justify-center gap-2 h-32 bg-navy-800 border border-navy-700 border-dashed rounded-xl hover:bg-navy-700 transition-colors text-content-secondary hover:text-white">
          ...
          <button data-testid='btn-suggestproduct-4'
            type="submit"
