...
const HIGH_RISK_E_CODES: Record<string, [IngredientRiskLevel, string]> = {
  ...
  'e410': ['safe',      'Locust Bean Gum — natural plant-based thickener. Safe and healthy soluble fiber.'],
  'e415': ['mild',      'Xanthan Gum — natural thickener from fermentation. Safe for most.'],
  'e433': ['harmful',   'Polysorbate 80 — disrupts gut microbiome in studies.'],
  'e450': ['caution',   'Diphosphates — raising agent / stabilizer. Excess phosphate can impact kidney and heart health.'],
  ...
  'e475': ['caution',   'Polyglycerol esters of fatty acids — synthetic emulsifier. Marker of ultra-processed foods.'],
  'e476': ['caution',   'PGPR — synthetic emulsifier. Common marker of low-grade chocolate processing.'],
  'e477': ['caution',   'Propane-1,2-diol esters of fatty acids — synthetic emulsifier. Marker of ultra-processed foods.'],
  'e481': ['caution',   'Sodium stearoyl-2-lactylate — synthetic emulsifier. Marker of ultra-processed foods.'],
  'e500': ['safe',      'Sodium Carbonates — baking soda. Traditional raising agent. Very safe.'],
  'e503': ['mild',      'Ammonium Carbonates — traditional raising agent. Safe (dissipates during baking).'],
